...
ALLOWED_HOSTS = ['52.89.1.131', 'localhost']
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(os.path.dirname(__file__), '../trip_planner/'),
...
FILES_DIR = os.path.abspath(os.path.join(BASE_DIR, '../trip_planner/templates'))
...
STATICFILES_DIR = [
    ...
    os.path.join(BASE_DIR, "trip_planner/static/")
]
